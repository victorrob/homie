...
foreach ($rooms as $room) {
    ...
    <form method="post" action="index.php?p=home&d=home" class="roomFactors" id="<?php echo $room['idRoom'] ?>">
        <div class="factors">
...
<form method="post" action="index.php?p=home&d=home" class="habitationFactors" id="lumiereForm">
...
<form method="post" action="index.php?p=home&d=home" class="habitationFactors" id="voletForm">
    <div>
        <div>
...
<form method="post" action="index.php?p=home&d=home" class="habitationFactors" id="chauffageForm">
...
<form method="post" action="index.php?p=home&d=home" class="habitationFactors" id="ventilationForm">
...
<form method="post" action="index.php?p=home&d=home" class="habitationFactors" id="modeAbsentForm">
    <div class="divLigne">
