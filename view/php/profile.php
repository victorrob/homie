		...
		<form id="formProfile" method="POST" action="index.php?p=profile&d=profile">
			<div id="name" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="nameButton"/>
				</div>
			...
			<div id="firstName" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="firstNameButton"/>
				</div>
			...
			<div id="birth" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="birthButton"/>
				</div>
			...
			<div id="email" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="emailButton"/>
				</div>
			...
			<div id="address" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="addressButton"/>
				</div>
			...
			<div id="phone" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="phoneButton"/>
				</div>
			...
			<div id="password" class="categoryForm">
				<div class="formText">
					...
					<input class="button customButton basic" type="button" value="Modifier" id="passwordButton"/>
				</div>
			...
			<div id="validate" class="categoryForm">
				...
				<input class="button customButton submit" type="submit" value="Valider" id="validateButton"/> <!-- submit -->
			</div>
		</form>
		<form method="POST" action="index.php?p=home">
			<input class="button customButton reset" type="submit" value="Annuler" id="validateButton"/> <!-- annuler -->
		</form>
	</fieldset>
</body>