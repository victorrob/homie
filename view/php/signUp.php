<h1>Inscription</h1>
    <form method="post" action="index.php?p=login&d=signUp">
        ...
        <label class="lblButton">J'accepte les <a href="index.php?p=conditionsOfUse">C.G.U</a><input type="checkbox" name="termOfUse" class="checkbox" required /><span class="checkbox"></span>
        </label>
